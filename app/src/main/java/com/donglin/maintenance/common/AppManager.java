...
public class AppManager {
    ...
    //管理所有activity
    public List<BaseAppCompatActivity> mActivityList;
    Subscription mSubscription;
    private Application mApplication;
    //当前在前台的activity
    private BaseAppCompatActivity mCurrentActivity;
     ...
     */
    public void setCurrentActivity(BaseAppCompatActivity currentActivity) {
     ...
     * @return
     */
    public BaseAppCompatActivity removeActivity(int location) {
        if (mActivityList == null) {
            //mActivity is null
            return null;
        }
    ...
    public void killActivity(Class<?> activityClass) {
        ...
        for (BaseAppCompatActivity activity : mActivityList) {
     ...
     * @return
     */
    public boolean activityInstanceIsLive(BaseAppCompatActivity activity) {
        if (mActivityList == null) {
            //mActivityList is null
            return false;
        }
     ...
     */
    public void killAll() {
        Iterator<BaseAppCompatActivity> iterator = getActivityList().iterator();
